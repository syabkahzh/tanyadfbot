...
class GeminiProcessor:
    ...
    async def filter_duplicates(
        ...
        # Pre-compute history word sets grouped by brand to avoid O(N*M) tokenization overhead
        # ⚡ Bolt Optimization: Grouping checks prevents redundant work in the inner loop
        ...
        for p in new_promos:
            ...
            if (
                ...
                is_dupe = False
                for r_words in history_words_by_brand.get(brand_key, []):
